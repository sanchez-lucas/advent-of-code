...
stopping_points_x_mul = 0
for (x, y, z, xx, yy, zz), _distance in sorted(distances.items(), key=lambda item: item[1]):
  ...
  if len(circuits) == 1:
    stopping_points_x_mul = x * xx
    break

print(stopping_points_x_mul)
